...
function WebHeader({ title, onMenu, onNotifications, onNavigate, onSignOut }: WebHeaderProps) {
    ...
    <header className="web-header">
      ...
      <div className="header-actions">
        ...
        <button className="icon-button notification-button" onClick={onNotifications} aria-label="Notifications">
          <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 22a2.3 2.3 0 0 0 2.2-2h-4.4A2.3 2.3 0 0 0 12 22zm7-5v-5a7 7 0 0 0-5.5-6.8V4a1.5 1.5 0 0 0-3 0v1.2A7 7 0 0 0 5 12v5l-2 2v1h18v-1l-2-2z" /></svg><i />
        </button>
